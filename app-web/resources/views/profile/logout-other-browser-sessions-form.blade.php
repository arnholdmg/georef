<x-jet-action-section>
    ...
    <x-slot name="description">
        Gerencia e desconecta outras sessões ativas em outros navegadores e dispositivos.
    </x-slot>

    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-600">
            Se necessário, você pode desconectar todas suas sessões em todos seus navegadores e dispositivos. Algumas de suas sessões recentes estão listadas abaixo; contudo, esta lista pode não ser precisa. Se você acredita que sua conta tenha sido comprometida, você deve também alterar sua senha.
        </div>
                        ...
                        <div class="ml-3">
                            ...
                            <div>
                                <div class="text-xs text-gray-500">
                                    ...
                                    @else
                                        Última vez online {{ $session->last_active }}
                                    @endif
                                </div>
                            </div>
                        </div>
        ...
        <x-jet-dialog-modal wire:model="confirmingLogout">
            ...
            <x-slot name="content">
                Por favor, digite sua senha para confirmar que deseja desconectar todas sessões ativas.
