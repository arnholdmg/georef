<div>
    ...
    <div class="mt-12 mb-6">
        <button type="button" class="text-xs text-red-900 float-right" onclick="confirm('Você tem certeza que deseja apagar essa área?\n\nTodos os pacientes cadastrados nessa área serão apagados juntamente.\n!!! Esta ação não poderá ser desfeita !!!') || event.stopImmediatePropagation()" wire:click="remove">
            Deletar Área
        </button>
    </div>
</div>